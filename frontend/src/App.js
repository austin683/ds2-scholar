...
function App() {
  ...
  return (
    <div className="flex h-screen bg-neutral-900 text-neutral-100 overflow-hidden" style={{ minHeight: '620px' }}>
      ...
      {/* Sidebar */}
      <aside
        className={`flex flex-col h-full bg-neutral-800 border-r border-yellow-700/40 transition-all duration-300 overflow-hidden ${
          ...
          >
            ...
            {STAT_FIELDS.map(({ key, label, icon }, i) => (
              <div key={key} className="flex flex-col gap-1.5" style={{ gridColumn: 1, gridRow: i + 1 }}>
                ...
                <input
                  ...
                  className="bg-neutral-700 border border-neutral-600 rounded px-2 py-1.5 text-xs text-neutral-100 focus:outline-none focus:border-yellow-600 w-full"
                  placeholder="—"
                />
              </div>
            ))}
            ...
            <div className="flex flex-col gap-1.5 overflow-hidden" style={{ gridColumn: 2, gridRow: '8 / span 2', alignSelf: 'stretch', marginTop: 0 }}>
              ...
              <textarea
                ...
                className="flex-1 bg-neutral-700 border border-neutral-600 rounded px-2 py-1.5 text-xs text-neutral-100 focus:outline-none focus:border-yellow-600 w-full resize-none"
                placeholder="—"
              />
            </div>
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        {/* Header */}
        <header className="flex items-center gap-3 px-5 h-[72px] bg-neutral-800 border-b border-yellow-700/40 shrink-0">
          <button
            onClick={() => setSidebarOpen(o => !o)}
            className="text-yellow-500 hover:text-yellow-400 transition-colors p-1 rounded hover:bg-neutral-700"
          ...
          {messages.length > 0 && (
            <button
              ...
              className="ml-auto text-neutral-400 hover:text-neutral-200 text-xs border border-neutral-600 hover:border-neutral-400 rounded px-3 py-1.5 transition-colors"
            >
              Clear Chat
            </button>
          )}
        ...
        <main className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3">
              ...
              <div className="w-full max-w-lg grid grid-cols-2 gap-2">
                {[
                  ...
                  <button
                    ...
                    className="text-center px-5 py-3.5 rounded-lg bg-neutral-800 border border-neutral-700 hover:border-yellow-700/60 hover:bg-neutral-750 text-neutral-400 hover:text-neutral-200 text-sm transition-colors leading-snug"
                  >
                    {label}
                  </button>
                ))}
              ...
              <div
                className={`max-w-[75%] px-4 py-2.5 text-sm leading-relaxed break-words ${
                  msg.role === 'user'
                    ...
                    : 'bg-neutral-700 text-neutral-200 rounded-2xl rounded-bl-none border border-neutral-600'
                }`}
              >
                {msg.role === 'user' ? msg.content : (
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      code: ({ children }) => <code className="bg-neutral-800 text-yellow-300 rounded px-1 py-0.5 text-xs font-mono">{children}</code>,
                      pre: ({ children }) => <pre className="bg-neutral-800 rounded p-3 mb-2 overflow-x-auto text-xs font-mono text-yellow-200">{children}</pre>,
                      hr: () => <hr className="border-neutral-600 my-2" />,
                      ...
                      th: ({ children }) => <th className="text-left text-[#c9a84c] font-semibold px-3 py-1.5 border border-neutral-600 whitespace-nowrap">{children}</th>,
                      td: ({ children }) => <td className="text-neutral-200 px-3 py-1.5 border border-neutral-600">{children}</td>,
                    }}
                  >
                    {msg.content}
                  </ReactMarkdown>
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-neutral-700 border border-neutral-600 rounded-2xl rounded-bl-none px-4 py-2.5 text-sm text-yellow-500 italic animate-pulse">
                Consulting the wiki...
              </div>
            </div>
          )}
        ...
        {/* Input */}
        <footer className="px-4 pt-[19px] pb-[19px] bg-neutral-800 border-t border-yellow-700/40 shrink-0">
          {/* Slash command menu */}
          {input.startsWith('/') && !input.includes(' ') && (() => {
            ...
            return (
              <div className="mb-2 bg-neutral-700 border border-neutral-600 rounded-lg overflow-hidden">
                {filtered.map(({ cmd, desc }) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 hover:bg-neutral-600 transition-colors flex items-baseline gap-2"
                  >
          ...
          <div className="flex gap-2 items-end">
            ...
            <button
              ...
              className="shrink-0 bg-yellow-600 hover:bg-yellow-500 active:bg-yellow-700 disabled:opacity-40 disabled:cursor-not-allowed text-neutral-900 font-semibold text-sm rounded-lg px-4 py-2.5 transition-colors"
            >
              Send
            </button>
          </div>
      ...
      {levelModalOpen && (() => {
        ...
        return (
          ...
          >
            <div
              className="bg-neutral-800 border border-yellow-700/40 rounded-xl px-6 py-9 w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto"
            ...
            >
              ...
              {levelStep === 'count' ? (
                ...
                <div className="flex flex-col items-center gap-4">
                  <p className="text-neutral-400 text-sm">How many levels did you gain?</p>
                  <input
                    type="number"
                    min="1"
                    value={levelCount}
                    ...
                    autoFocus
                    className="bg-neutral-700 border border-neutral-600 rounded px-3 py-2 text-center text-neutral-100 text-xl w-24 focus:outline-none focus:border-yellow-600"
                    placeholder=""
                  />
                  <div className="flex gap-2 w-full mt-2">
                    <button
                      onClick={handleCloseLevelModal}
                      className="flex-1 bg-neutral-700 hover:bg-neutral-600 text-neutral-200 text-sm font-semibold rounded py-2 transition-colors"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="flex-1 bg-yellow-600 hover:bg-yellow-500 disabled:opacity-40 disabled:cursor-not-allowed text-neutral-900 text-sm font-semibold rounded py-2 transition-colors"
                    >
                      Continue
                    </button>
                  </div>
                ...
                <>
                        ...
                        <div key={key} className="flex flex-col items-center gap-1.5">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="w-6 h-6 flex items-center justify-center rounded bg-neutral-700 hover:bg-yellow-600 disabled:opacity-30 disabled:cursor-not-allowed text-neutral-200 hover:text-neutral-900 transition-colors text-xs"
                            >
                              ▲
                            </button>
                          </div>
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-yellow-600 hover:bg-yellow-500 active:bg-yellow-700 text-neutral-900 text-sm font-semibold rounded py-2 transition-colors"
                    >
                      Confirm
                    </button>
                  </div>

# Source: https://darksouls2.wiki.fextralife.com/Forrest+Grotesque

| Forrest Grotesque | Forrest Grotesque |
    | --- | --- |
    |  |  |
    | HP | ?? |
    | Weakness | ? |
...
**Forrest Grotesque** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Forrest Grotesque Information in Dark Souls 2
...
### DKS2 Forrest Grotesque Location

  * [Things Betwixt](/Things+Betwixt "Dark Souls 2 Things Betwixt")

### Forrest Grotesque Drops in DKS2

  * Drops go here.

### Dark Souls 2 Forrest Grotesque Strategy Tips
...
### Bare fists
    ...
    | --- | --- | --- | --- | --- |
    | NG: 160 / NG+: 345 / NG+7: 659 | Magic | - | Yes | Yes |
    

**Location** : [Things Betwixt](/Things+Betwixt "Dark Souls 2 Things Betwixt")   
**NG** : yes   
**Move set**   

  * Fist Swing: The enemy will swing at the player when in close range, can be up to a 2 swing combo. 
    * Physical Damage
    * Can be blocked

**Drops**   

  * Souls: NG: 30 NG+: 60 NG+7: 120
...
**Move set**   
  ...
  * Shoot : Shoots at the player when in range. 
    * Physical Damage
    * Can be blocked
  * Sword Slash + Fist Swing: When a player come into melee range, that archer will draw a sword and can swing at you with either hand. 
    * Physical Damage
    * Can be blocked

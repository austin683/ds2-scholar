# Source: https://darksouls2.wiki.fextralife.com/Poison+Moth

| Poison Moth (Great Moth) | Poison Moth (Great Moth) |
    | --- | --- |
    |  |  |
    | HP | NG: 170 / NG+: 525 / NG+7: 600 |
    | Weakness | Fire |
    | Resistance | ? |
    | Respawns | Yes |
    

**Poison Moth (Great Moth)** is an [enemy](/enemies "Dark Souls 2 enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. **Poison Moth (Great Moth)** , perched in the trees, release occasional clouds of poisonous spores. Swiftly accumulating poison can catch the unwary, so be cautious or eliminate them with ranged weapons, as they are fragile. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Poison Moth (Great Moth) Information in Dark Souls 2

_"Edit Moon Butterflies that sit in the trees and periodically emit a cloud of poisonous spores. Poison can build up very quickly if you're not aware of where and when the clouds will spawn, so exercise caution, or just kill them with ranged weapons as they die very easily, the armor Moon Butterfly Set is based on this creature.__"_

### Dark Souls 2 Poison Moth (Great Moth) Location

  * [Huntsman's Copse](/Huntsman%27s+Copse "Dark Souls 2 Huntsman%27s Copse")

### Poison Moth (Great Moth) Drops in DS2

  * [Poison Moss](/Poison+Moss "Dark Souls 2 Poison Moss")
  * NG: 60 Souls,NG+ 120 Souls, NG+7: 240Souls.

### Dark Souls 2 Strategy Tips

  * **\--**

### Poison Moth (Great Moth) Move Set in Dark Souls 2

  * Poison Mist 
    * Inflicts poison.

### Dark Souls 2 Poison Moth (Great Moth) Notes and Tips

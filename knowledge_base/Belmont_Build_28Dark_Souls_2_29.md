# Source: https://darksouls2.wiki.fextralife.com/Belmont+Build+%28Dark+Souls+2%29

| Belmont Build | Belmont Build | Belmont Build | Belmont Build | Belmont Build |
    | --- | --- | --- | --- | --- |
    |  |  |  |  |  |
    |  |  |  |  |  |
    | 190 | 35 | 35 | 20 | 16 |
...
This is a build inspired by the Belmont Clan from the Castlevania Series 
  ...
  * Build Name: Belmont Family
  * Build Author: MeowMeowGaming
  * Build Level:190
  * Starting Class & Gift: Swordsman, Petrified Something
  * Build Focus: (pvp, pve?) Either, however, I built it around PvP.
  * Build Main Stat: Dex and Faith
  * Link to [Dark Souls 2Calculator](https://fextralife.com/calculator/dks2builds.html): <https://fextralife.com/calculator/dks2builds.html?KOumxhHXu.DSvXGol2b.FcXfSLO.kDMPKa.A.A.DWse34>   
...
This build is really fun! I didn't win that much, but I had more fun with this than I did my main build. It's definitely a challenge, so be prepared to die a lot. I do think that using this can make you better at the game, as you can't spam R1 the entire time. Have fun!   
    ...
    | Builds |
    | --- |
    | Bare Hands PvP Belmont Build (Dark Souls 2) Dark Pyromancy Flame Glass Cannon Demon Hunter Dexbro Giant Dad 2.0 Grimlock (FoC) HammerTime Hand of God Herald of Death Jedi Knight King Grimlock Master Dex Build Melkor Mystic Knight Pyro Warrior Ranger Snipecaster-Battlemage PvE Build Tainted Pilgrim Taking The Black The Zach Murray |
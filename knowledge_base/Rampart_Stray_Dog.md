# Source: https://darksouls2.wiki.fextralife.com/Rampart+Stray+Dog

| Rampart Stray Dog | Rampart Stray Dog |
    | --- | --- |
    |  |  |
    | HP | ?? |
    | Weakness | ? |
...
**Rampart Stray Dog** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Rampart Stray Dog Information in Dark Souls 2

_DESCRIPTION_

### Rampart Stray Dog Location in DS2

  * Location go here

### DS2 Rampart Stray Dog Drops

  * TBA

### Rampart Stray Dog Strategy Tips in Dark Souls 2

  * **\--**

### Dark Souls 2 Rampart Stray Dog Move Set

# Source: https://darksouls2.wiki.fextralife.com/Ironclad+Soldier

| Ironclad Soldier | Ironclad Soldier |
    | --- | --- |
    |  |  |
    | HP | NG: 900 / NG+: 525 / NG+7: 1,000 |
    | Weakness | Strike / Lightning |
    | Resistance | Slash / Thrust / Magic |
    | Respawns | Yes |
    

**Ironclad Soldier** is an [enemy](/enemies "Dark Souls 2 enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. These are the initial formidable 'heavy hitters' you encounter. Clad in heavy armor resembling a turtle's shell, they boast immense defense and are challenging to stagger. These armored juggernauts wield massive footman's maces, designed to crush defenders into paste. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Ironclad Soldier Information in Dark Souls 2
...
Note that the Ironclads found in Iron keep are identical, but they have more health, and defense, and cause more damage than their weaker brethren.

### Ironclad Soldier Location in DKS2

  * [Iron Keep](/Iron+Keep "Dark Souls 2 Iron Keep")

### Ironclad Soldier Ironclad Soldier Drops

  * [Ironclad Set](/Ironclad+Set "Dark Souls 2 Ironclad Set")
  * [Human Effigy](/Human+Effigy "Dark Souls 2 Human Effigy")
  * [Large Titanite Shard](/Large+Titanite+Shard "Dark Souls 2 Large Titanite Shard")
  * NG: 250 Souls,NG+ 500 Souls, NG+7: 1,000 Souls.

### Ironclad Soldier Strategy Tips in Ironclad Soldier

  * Circle strafe right. Stay back from the overhead slam attack. Wait for the single-swipe and then run in to the right, behind the swipe. Get a hit or two, and roll off. They will often turn their back to bait the player into its backwards turtle crush attack.afar.

### DKS2 Ironclad Soldier Move Set

  * Foward Hammer Slam: Standard attack - knocks player onto back. 
    * Physical Damage
    * Cannot be blocked
  * Charging Hammer Slam : Raises hammer over head, charges at player for a forward hammer slam. Knocks player back if it connects 
    * Physical Damage
    * Cannot be blocked
  * Single Cross-swipe : Standard attack - knocks player onto back. 
    * Physical Damage
    * Cannot be blocked
  * Foward Hammer Slam: Standard attack, right to left. 
    * Physical Damage
    * Cannot be blocked
  * Multi-swing Combo : 4 horizontal swings in a row. 
    * Physical Damage
    * Can be blocked
  * Backwards Turtle Crush: Fall backwards onto player if the player gets behind for too long. 
    * Physical Damage
    * Can be blocked
...
### Dark Spirit Variant
    ...
    | --- | --- | --- | --- | --- |
    | NG: 900 / NG+: 1,750 / NG+7: 3,350 | Strike / Lightning | Slash / Thrust / Magic | No | No |

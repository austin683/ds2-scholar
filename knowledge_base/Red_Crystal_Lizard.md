# Source: https://darksouls2.wiki.fextralife.com/Red+Crystal+Lizard

| Red Crystal Lizard | Red Crystal Lizard |
    | --- | --- |
    |  |  |
    | HP | NG: 330 / NG+: ? / NG+7: ? |
    | Weakness | ? |
...
**Red Crystal Lizard** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Red Crystal Lizard Information

**Red Crystal Lizards** are non-respawning enemies which will scurry away if a player approaches them and explode if gets too close.

### Red Crystal Lizard Location in DS2
...
### Red Crystal Lizard Drops in Dark Souls 2

  * Nothing

### Dark Souls 2 Red Crystal Lizard Strategy Tips

  * **\--**

### Red Crystal Lizard Variants in DS2

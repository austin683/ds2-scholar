# Source: https://darksouls2.wiki.fextralife.com/Poison+Statue+Cluster

| Poison Statue Cluster | Poison Statue Cluster |
    | --- | --- |
    |  |  |
    | HP | ?? |
    | Weakness | Projectile |
...
**Poison Statue Cluster** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. Akin to those in the Gutter, now pose a greater threat as they are carried by creatures and can assail from various angles. Resistant to most attacks, targeting the carrier with precise projectiles or area-of-effect spells is the key to overcoming these formidable foes. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Poison Statue Cluster Information
...
### Poison Statue Cluster Location in Dark Souls 2
...
### Dark Souls 2 Poison Statue Cluster Drops
...
### DS2 Poison Statue Cluster Strategy Tips
...
### Poison Statue Cluster Move Set in Dark Souls 2

  * Poison Spit

  * Petrify Spit

### Dark Souls 2 Poison Statue Cluster Notes & Tips

# Source: https://darksouls2.wiki.fextralife.com/Witchtree

| Witchtree | Witchtree |
    | --- | --- |
    |  |  |
    | HP | NG: 560 / NG+: 680 / NG+7: 1,280 |
    | Weakness | ? |
    | Resistance | ? |
    | Respawns | YES |
    

**Witchtree** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. Witchtree, a spectral entity haunting the Dark Chasm, discovered within the confines of the [Dark Chasm of Old](/Dark+Chasm+of+Old "Dark Souls 2 Dark Chasm of Old"). [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Witchtree Information

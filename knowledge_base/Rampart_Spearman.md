# Source: https://darksouls2.wiki.fextralife.com/Rampart+Spearman

| Rampart Spearman | Rampart Spearman |
    | --- | --- |
    |  |  |
    | HP | ?? |
    | Weakness | ? |
...
**Rampart Spearman** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Rampart Spearman Information in Dark Souls 2

_DESCRIPTION_

### Dark Souls 2 Rampart Spearman Location

  * Location go here

### Rampart Spearman Drops in Dark Souls 2

  * [Ice Rapier](/Ice+Rapier "Dark Souls 2 Ice Rapier")
  * [Radiant Lifegem](/Radiant+Lifegem "Dark Souls 2 Radiant Lifegem")

### DS2 Rampart Spearman Strategy Tips

  * Avoid their grab attack
  * Keep your distance during the spinning attack

### Rampart Spearman Move Set in Dark Souls 2

  * Winged Spear
  * Soul Spear

### Dark Souls 2 Rampart Spearman Notes and Tips

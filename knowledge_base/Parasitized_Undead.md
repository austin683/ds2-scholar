# Source: https://darksouls2.wiki.fextralife.com/Parasitized+Undead

| Parasitized Undead | Parasitized Undead |
    | --- | --- |
    |  |  |
    | HP | NG: 700 / NG+: 1,150 / NG+7: 2,200 |
    | Weakness | Fire |
    | Resistance | ? |
    | Respawns | YES |
    

**Parasitized Undead** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. **Parasitized Undead** , once residents of Brightstone Cove, now hosts for invading spiders. This gruesome fate, undeserved by its victims, turns the living host into a source of nourishment for the spiders as they seek new sources of food. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Parasitized Undead Information in DS2
...
### Parasitized Undead Drops in Dark Souls 2
  ...
  * [Prism Stone](/Prism+Stone "Dark Souls 2 Prism Stone")
  * [Tseldora Set](/Tseldora+Set "Dark Souls 2 Tseldora Set")
  * Souls: NG: 360 NG+: 720 NG+7: 1,440

### Dark Souls 2 Parasitized Undead Strategy Tips

  * **\--**

### Parasitized Undead Move Set in DS2

  * TBA

### Dark Souls 2 Parasitized Undead Notes and Tips

  * The alternative for the Tseldora set if you don't want to kill your fashion souls supplier.

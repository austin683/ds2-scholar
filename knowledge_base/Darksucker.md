# Source: https://darksouls2.wiki.fextralife.com/Darksucker

| Darksucker | Darksucker |
    | --- | --- |
    |  |  |
    | HP | NG: 475 / NG+: 700 / NG+7: 1,600 |
    | Weakness | Fire |
    | Resistance | - |
    | Respawns | YES |
    

**Darksucker** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. **Darksuckers** are black, multi-tentacled monsters that emerge from tar pools in Black Gulch. When a player approaches, they burst out and will consume the player if they linger in one spot for too long. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Darksucker Information in Dark Souls 2

_Black, many-tentacled monsters that, when a player approaches, will burst out from the black tar pools on the floor of Black Gulch and will eat the player if he stands in one spot for too long. To deal with them easily, use pyromancy or a fire arrow from afar to light their pools on fire. This will quickly burn the creatures to death without them leaving their hole at all._

### Dark Souls 2 Darksucker Location

  * [Black Gulch](/Black+Gulch "Dark Souls 2 Black Gulch")

### Darksucker Drops in Dark Souls 2
  ...
  * Souls: NG: 300 NG+: 600 NG+7: 1200

### DKS2 Darksucker Strategy Tips

  * **\--**

### Darksucker Move Set in DKS2

  * **Grab Attack**
  * **Tail Sweep**

### Dark Souls 2 Darksucker Notes and Tips

# Source: https://darksouls2.wiki.fextralife.com/Wall+Watchman

| Wall Watchman | Wall Watchman |
    | --- | --- |
    |  |  |
    | HP | ?? |
    | Weakness | ? |
...
**Wall Watchman** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Wall Watchman Information

_DESCRIPTION_

### Wall Watchman Location in Dark Souls 2

  * [Frozen Eleum Loyce](/Frozen+Eleum+Loyce "Dark Souls 2 Frozen Eleum Loyce")

### DKS2 Wall Watchman Drops

  * [Divine Blessing](/Divine+Blessing "Dark Souls 2 Divine Blessing") (all three)
  * [Elite Knight Set](/Elite+Knight+Set "Dark Souls 2 Elite Knight Set") (Drakekeeper's Warpick wielding, Greatsword wielding)
  * [Knight Set](/Knight+Set "Dark Souls 2 Knight Set") (Drakekeeper's Sword wielding)

### Wall Watchman Strategy Tips in DKS2

  * Obtaining the Eye of the Priestess will make fighting them much easier. Without the Eye, they are so transparent as to be nearly invisible, especially while the snow is blowing.
  * Without the Eye, the same strategies as for fighting Forest Guardians apply.
  * Using a weapon with a high Poise Damage value to stagger them is effective, as is using attacks that knock them down.
  * They do not respawn.

### Dark Souls 2 Wall Watchman Move Set

  * TBA

### Wall Watchman Notes and Tips in Dark Souls 2

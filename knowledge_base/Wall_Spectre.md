# Source: https://darksouls2.wiki.fextralife.com/Wall+Spectre

| Wall Spectre | Wall Spectre |
    | --- | --- |
    |  |  |
    | HP | NG: 240 / NG+: 300 / NG+7: 580 |
    | Weakness | Lightning |
    | Resistance | ? |
    | Respawns | YES |
    

**Wall Spectre** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. **Wall Spectre** , the ethereal remains of a past warrior, capable of phasing through specific sections of the [Undead Crypt](/Undead+Crypt "Dark Souls 2 Undead Crypt") walls to assail unsuspecting intruders. These greenish, translucent apparitions emerge from the walls to launch attacks upon approaching players. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Wall Spectre Information in Dark Souls 2

_The ghost of a former warrior which will phase through the walls of the Undead Crypt in certain spots to attack. Who were these warriors in life and how did they come to wander the halls of the Crypt? Only the Grave Wardens know for certain, and their lips are sealed._

_Greenish, translucent ghosts which, when a player gets close enough, emerge from a wall and attack the player._

Torr from Chase and Torr likes to call them "Wall Hector"

### Dark Souls 2 Wall Spectre Location

  * [Undead Crypt](/Undead+Crypt "Dark Souls 2 Undead Crypt")

### Wall Spectre Drops in DKS2

  * NG: 200 Souls,NG+ 400 Souls, NG+7: 800 Souls.

### WDKS2 all Spectre Strategy Tips

  * **\--**

### Wall Spectre Move Set in Dark Souls 2

  * TBA

### Dark Souls 2 Wall Spectre Notes and Tips

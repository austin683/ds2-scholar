# Source: https://darksouls2.wiki.fextralife.com/Bonewheel+Skeleton

| Bonewheel Skeleton | Bonewheel Skeleton |
    | --- | --- |
    |  |  |
    | HP | NG: 260 / NG+: 520 / NG+7: 988 |
    | Weakness | Fire |
    | Resistance | - |
    | Respawns | Yes |
    

**Bonewheel Skeleton** is an [enemy](/enemies "Dark Souls 2 enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Bonewheel Skeleton Information 

"Skeletons stuck on wheels."

### Bonewheel Skeleton Location in DS2

  * [Majula](/Majula "Dark Souls 2 Majula") (in the basement of Mansion of [Cale the Cartographer](/Cale+the+Cartographer "Dark Souls 2 Cale the Cartographer")) (NG++ and up)
  * [Huntsman's Copse](/Huntsman's+Copse "Dark Souls 2 Huntsman's Copse")
  * spawned by one of the [Skeleton Lords](/Skeleton+Lords "Dark Souls 2 Skeleton Lords")

### Dark Souls 2 Bonewheel Skeleton Drops

  * [Alluring Skull](/Alluring+Skull "Dark Souls 2 Alluring Skull")
  * NG: 380 Souls, NG+ 760 Souls, NG+7: 1,520 Souls.

### Bonewheel Skeleton Strategy Tips in DS2

  * **\--**

### Dark Souls 2 Bonewheel Skeleton Move Set

  * \--

### Bonewheel Skeleton Notes and Tips in Dark Souls 2

  * Skeletons defeated inside a boss room have no impact on the duration of co-op. See [Online](/Online "Dark Souls 2 Online") for more detailed information about Multiplayer Time Limits.

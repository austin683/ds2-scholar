# Source: https://darksouls2.wiki.fextralife.com/Foreign+Wanderer+(Under+Traveler)

| Foreign Wanderer | Foreign Wanderer |
    | --- | --- |
    |  |  |
    | HP | Around 100 base game. |
    | Weakness | ? |
    | Resistance | ? |
    | Respawns | Yes |
    

**Foreign Wanderer** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. The Undead Travelers in [Things Betwixt](/Things+Betwixt "Dark Souls 2 Things Betwixt") are all hostile, adorned in imported clothing akin to your initial gear at the start of your journey. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Foreign Wanderer Information
...
### Foreign Wanderer Location in DKS2

  * [Things Betwixt](/Things+Betwixt "Dark Souls 2 Things Betwixt")

### DKS2 Foreign Wanderer Drops

  * None

### Foreign Wanderer Strategy Tips in DKS2

  * **\--**

### Dark Souls 2 Foreign Wanderer Move Set
...
### Foreign Wanderer Notes and Tips in Dark Souls 2

# Source: https://darksouls2.wiki.fextralife.com/Swollen+Mongrel

| Swollen Mongrel | Swollen Mongrel |
    | --- | --- |
    |  |  |
    | HP | NG: 1,100 - 1,550 / NG+: 2,000 / NG+7: ? |
    | Weakness | Fire |
    | Resistance | - |
    | Respawns | YES |
    

**Swollen Mongrel** is an [enemy](/Enemies "Dark Souls 2 Enemies") in [Dark Souls 2](/Dark+Souls+2+Wiki "Dark Souls 2 Wiki")**(DKS2)**. **Swollen Mongrels** are grotesque, dog-like creatures that slash and bite when the player approaches. While not very fast, they can be effectively dealt with using ranged attacks. [Enemies](/Enemies "Dark Souls 2 Enemies") have their own behavior and unique attacks, killing enemies provide various drops that reward players with items and souls.

### Dark Souls 2 Swollen Mongrel Information
...
### Swollen Mongrel Location in Dark Souls 2

  * [The Gutter](/The+Gutter "Dark Souls 2 The Gutter")
  * [Aldia's Keep](/Aldia%27s+Keep "Dark Souls 2 Aldia%27s Keep")

### DKS2 Swollen Mongrel Drops

  * [Aromatic Ooze](/Aromatic+Ooze "Dark Souls 2 Aromatic Ooze")
  * Souls: NG: 660 NG+: 1,320 NG+7: 2,640

### Swollen Mongrel Strategy Tips in DKS2

  * **\--**

### Dark Souls 2 Swollen Mongrel Move Set

  * Fist Swing: The enemy will swing at the player when in close range, can be up to a 2 swing combo. 
    * Physical Damage
    * Can be blocked

### Swollen Mongrel Notes and Tips in Dark Souls 2
